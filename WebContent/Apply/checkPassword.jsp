...
<head>
  ...
  <body>
  	...
  	<form action="AP_CheckAction.action" method="post">
  	<s:hidden name="apply_no" value="%{apply_no}" />
      ...
      <tr>
        ...
        <td width="150" bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:textfield name="apply_passwd" theme="simple" cssStyle="width:100px" maxlength="20"/>
