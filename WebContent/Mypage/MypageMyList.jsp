	...
	<tr>
		...
		<td align="right">
		 		<s:if test="searchKeyword != ''">
 					<s:if test="searchNum == 0">[제목으로 '</s:if>
 					<s:else>[내용으로 '</s:else>
...
<table border="0">
				<tr align="center" >
						...
						<td width="520"><strong>제목</strong></td>        	
					...
					<tr bgcolor="#FFFFFF"  align="center">
        				...
        				<td align="left"> &nbsp;
        					<s:if test="rboard_index == 1"><font color="blue">후기게시판</font></s:if>
      	      		...
      	      		<tr>
      	      			<td align="left"><font color="gray">내용 : <s:property value="rboard_content" /></font></td>
      	     		 <tr bgcolor="#777777">
        				<td height="1" colspan="5"></td>
      				</tr>
      				</s:iterator>
